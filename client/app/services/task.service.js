...
var TaskService = (function () {
    ...
    TaskService.prototype.getTasks = function (login, password) {
    ...
    TaskService.prototype.getOnTask = function (id) {
        return this.http.put('/api/book/' + id, { "id": id })
            .map(function (res) { return res.json(); });
    };
    TaskService.prototype.addBook = function (newTask) {
    ...
    TaskService.prototype.editBook = function (id, edit) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.http.put('/api/book/' + id, JSON.stringify(edit), { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TaskService.prototype.updateStatus = function (book) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
